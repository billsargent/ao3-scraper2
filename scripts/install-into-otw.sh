...
cp "$SOURCE_DIR"/private_archive_initializer.rb "$OTW_DIR/config/initializers/private_archive.rb"
cp "$SOURCE_DIR"/docker-compose.low-memory.yml "$OTW_DIR/docker-compose.preservation-test.yml"
cp "$SOURCE_DIR"/docker-compose.private.yml "$OTW_DIR/docker-compose.private.yml"
cp "$SOURCE_DIR"/script/create_offline_archivist.rb "$OTW_DIR/script/create_offline_archivist.rb"
